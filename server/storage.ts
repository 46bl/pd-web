  ...
  private initializeProducts() {
    const initialProducts: Omit<Product, "id">[] = [
      ...
      // DMA Products
      {
        ...
        inStock: true,
        imageUrl: "",
        deliveryUrl: "https://secure.pdcheats.uk/downloads/dma-firmware.zip",
        licenseKey: "DMA-FW-2025-XXXX",
        deliveryType: "download",
      },
      {
        name: "DMA Firmware - Private 1:1",
        description: "Exclusive private 1:1 DMA firmware with personalized setup and support",
        price: "250.00",
        originalPrice: null,
        category: "DMA Hardware",
        game: "Multi-Game",
        ...
        inStock: true,
        imageUrl: "",
        deliveryUrl: "https://secure.pdcheats.uk/downloads/dma-firmware-private.zip",
